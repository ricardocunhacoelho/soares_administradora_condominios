...
const Color kDarkGrey = Color.fromARGB(255, 110, 110, 110);
...
const Color kMediumDarkBlue = Color.fromARGB(255, 55, 69, 95);
...
final kNoticiaBold = GoogleFonts.noticiaText(
  color: kDarkBlue,
  fontWeight: FontWeight.w700,
);
final kNoticiaSemiBold = GoogleFonts.noticiaText(
  color: kDarkBlue,
  fontWeight: FontWeight.w600,
);
final kNoticiaMedium = GoogleFonts.noticiaText(
  color: kDarkBlue,
  fontWeight: FontWeight.w500,
);
final kNoticiaRegular = GoogleFonts.noticiaText(
  color: kDarkBlue,
  fontWeight: FontWeight.w400,
);

final kDoppio_One = GoogleFonts.doppioOne(
  color: kDarkBlue,
  fontWeight: FontWeight.w700,
);
