...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  PaymentBloc(this.makeReserveUsecase) : super(const PaymentState()) {
  ...
  Future<Map<String, dynamic>> _callPayEndpointIntentId({
    ...
    final url = Uri.parse(
        'https://us-central1-soares-administradora-condomin.cloudfunctions.net/StripePayEndpointIntentId');
  ...
  Future<Map<String, dynamic>> _callPayEndpointMethodId({
    ...
    final url = Uri.parse(
        'https://us-central1-soares-administradora-condomin.cloudfunctions.net/StripePayEndpointMethodId');
